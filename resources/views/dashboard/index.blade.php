...
@section('content')
    ...
    <div class="charts-container"
        ...
        <!-- ============================================== -->
        <div class="chart-card dashboard-chart" id="chart1"
            style="background: white; padding: 24px; border-radius: 24px; box-shadow: 0px 1px 4px rgba(0, 0, 0, 0.15);">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
                <div style="color: #132440; font-size: 18px; font-family: 'Poppins', sans-serif; font-weight: 500;">Total
                    Penjualan</div>
        ...
        <!-- ============================================== -->
        <div class="chart-card dashboard-chart" id="chart2"
            style="background: white; padding: 24px; border-radius: 24px; box-shadow: 0px 1px 4px rgba(0, 0, 0, 0.15);">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
                <div style="color: #132440; font-size: 18px; font-family: 'Poppins', sans-serif; font-weight: 500;">Top
                    Paket Beasiswa</div>
                <select id="filterTopBeasiswa"
                    style="padding: 4px 12px; border-radius: 8px; border: 1px solid #e2e8f0; font-family: 'Inter', sans-serif; font-size: 14px; outline: none; background: white; cursor: pointer;">
